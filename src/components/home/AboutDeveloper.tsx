...
export default function AboutDeveloper() {
    const stats = [
        { value: "3000+", label: "Industrial Sheds" },
        { value: "2000+", label: "Warehouses" },
            ...
            <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                ...
                <div className="w-full lg:w-1/2 flex flex-col">
                    ...
                    >
                        ...
                        <span className="font-normal italic text-primary">Industrial Real Estate.</span>
                    </motion.h2>
                    ...
                    >
                        <p>
                            With two decades of expertise and professionalism, Divya Estate Management has been the source of many dreams turning to reality with the ability to access all industrial services under one roof.
                        </p>
                        <p>
                            We specialize in providing Industrial Shed for Rent in Ahmedabad, Gujarat along with high-quality warehouses, industrial land, pre-leased properties, and complete industrial turnkey project solutions.
                        </p>
                    </motion.div>
                    ...
                    >
                        <span className="relative z-10 font-semibold transition-colors duration-500">Explore Industrial Services</span>
